...
export default {
  ...
  setup() {
    ...
    const method = {
      ...
      toGithub():void {
        window.location.href='https://github.com/login/oauth/authorize?client_id=6c85823c1a121313be52&state=s76de&redirect_uri=http://47.119.167.128:3000/api/blog/github'
      }
    };
    return {
      ...toRefs(data),
