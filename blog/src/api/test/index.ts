...
export const favour = async (params: any) => {
    return await api.post('/api/blog/acticle/favour',params);
};

export const unfavour = async (params: any) => {
    return await api.post('/api/blog/acticle/unfavour',params);
};
